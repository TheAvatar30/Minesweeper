...
public class MinesButton extends JButton implements ActionListener, MouseListener {
    ...
    MinesweeperGUI myGUI;   //Konstruktor bekommt GUI
                            //wenn clicked -> methode in GUI aufrufen
    int thisX;
    int thisY;
    
    public MinesButton(String icon, String object, MinesweeperGUI pMyGUI, int x, int y) {
